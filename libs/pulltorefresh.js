...
(function ($) {
    $.pullToRefresh = function (element, options) {
        ...
        self.initNode = function () {
            ...
            $element.on('touchstart', onTouchStart.bind(this)).on('touchmove', onTouchMove.bind(this)).on('touchend', onTouchEnd.bind(this));
        };
        ...
        var onTouchMove = function (event) {
            var settings = self.settings, currentPageY = event.originalEvent.touches[0].pageY, diff = currentPageY- self.startPageY;
            if (!!isLoading) {
