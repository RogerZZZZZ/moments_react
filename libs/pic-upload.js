jQuery(function() {
    ...
    uploader = WebUploader.create({
        ...
        chunked: true,
        server: window.ipAddress + ':8080/moments/fileupload.php',
        fileNumLimit: 300,
    ...
    uploader.on('uploadSuccess', function(file, response) {
        ...
        window.delteFileSrc += ('@' + response.temp);
        window.addFileSrc += ('@' + response.save);
        console.log(window.delteFileSrc);
        console.log(window.addFileSrc);
    })
